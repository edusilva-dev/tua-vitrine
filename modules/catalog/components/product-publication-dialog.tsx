...
export function ProductPublicationDialog({
  ...
  return (
    <Dialog open={required}>
      <DialogContent showCloseButton={false} className="max-h-[90vh] overflow-hidden sm:max-w-xl">
        <DialogHeader>
          <DialogTitle>Escolha os produtos da sua vitrine</DialogTitle>
          <DialogDescription>
            Seu plano permite {limit} produtos publicados. Seus outros produtos continuarão salvos
            como rascunho.
          </DialogDescription>
        </DialogHeader>
        {loading ? (
