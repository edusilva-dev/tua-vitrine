...
-- CreateIndex
CREATE INDEX "StoreMember_userId_createdAt_idx" ON "StoreMember"("userId", "createdAt");
...
ALTER TABLE "StoreMember" ADD CONSTRAINT "StoreMember_owner_role" CHECK ("role" = 'OWNER');
